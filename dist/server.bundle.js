...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LinkContainer = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormControl = __webpack_require__(51);

	var _FormControl2 = _interopRequireDefault(_FormControl);

	var _LatestDevice = __webpack_require__(37);

	var _LatestDevice2 = _interopRequireDefault(_LatestDevice);

	var _LoadingMap = __webpack_require__(34);
	...
	var _reactDatetime = __webpack_require__(58);
	...
	var Dashboard = function (_Component) {
	  ...
	  _createClass(Dashboard, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _axios2.default.get('/all/public/devices', config).then(function (response) {
	        if (response) {
	      ...
	      _axios2.default.get('/all/public/devices/citiesloc', config).then(function (response) {
	        if (response) {
	    ...
	    value: function realTimeData(id, time) {
	      _axios2.default.get('/all/public/data/cur/' + id, config).then(function (response) {
	        if (response) {
	    ...
	    value: function analyticsData(id, time) {
	      ...
	      _axios2.default.get('/all/public/data/range/' + id + '?gte=' + gte + '&lte=' + lte, config).then(function (response) {
	        if (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Community = __webpack_require__(33);

	var _Community2 = _interopRequireDefault(_Community);

	var _Openapi = __webpack_require__(39);

	var _Openapi2 = _interopRequireDefault(_Openapi);

	var _Device = __webpack_require__(38);

	var _Device2 = _interopRequireDefault(_Device);

	var _Partners = __webpack_require__(40);

	var _Partners2 = _interopRequireDefault(_Partners);

	var _Airowl = __webpack_require__(30);
	...
	var _iframe = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cssnext = __webpack_require__(48);
	var postcssFocus = __webpack_require__(49);
	var postcssReporter = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Helmet = __webpack_require__(61);
	...
	var _TabList = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GoogleMapLoader = __webpack_require__(60);

	var _GoogleMapLoader2 = _interopRequireDefault(_GoogleMapLoader);

	var _GoogleMap = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DropdownButton = __webpack_require__(13);
	...
	var CalendarView = function (_Component) {
	  ...
	  function CalendarView(props) {
	    ...
	    _axios2.default.get('/all/public/analytics/range/' + _this.props.markerId + '?gte=' + gte + '&lte=' + lte, config).then(function (res) {
	        ...
	        if (diff.asDays() > 0) {
	          ...
	          (function () {
	            ...
	            if (diffN >= 3) {
	              ...
	              var today = new Date();
	              var gte = parseInt(new Date(today.getTime() - 1 * 24 * 60 * 60 * 1000).getTime() / 1000);
	              _axios2.default.get('/all/public/data/daily/' + _this3.props.id + '?gte=' + gte + '&lte=' + lte, config).then(function (res) {
	                Data = res.data;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GraphView = __webpack_require__(36);

	var _GraphView2 = _interopRequireDefault(_GraphView);

	var _CalendarView = __webpack_require__(35);
	...
	var _OverlayTrigger = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _limits = __webpack_require__(46);
	...
	var Iframe = function (_Component) {
	  ...
	  function Iframe(props) {
	    ...
	    _this.staticFieldsData = _fields2.default;
	    _this.staticLimitsData = _limits2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webpackConfig = __webpack_require__(20);
	...
	module.exports = [
		{
			...
			"type": "GUJT",
			"cat": "light",
			"description": "Value of UV Light in mV",
			"types": "string",
			"min": "0",
			"max": "2000",
			"unit": "mV"
		},
		{
			...
			"type": "GUJT",
			"cat": "dust",
			"description": "Value of Dust in ug/m3",
			"types": "string",
			"min": "0",
			"max": "500",
			"unit": "ug/m3"
		},
		{
			...
			"type": "GUJT",
			"cat": "gases",
			"description": "Value of CO in mg/m3",
			"types": "string",
			"min": "0",
			"max": "50",
			"unit": "mg/m3"
		...
		},
		{
			...
			"type": "GUJT",
			"cat": "dust",
			"description": "Value of Dust particles less then 10 micron in ug/m3",
			"types": "string",
			"min": "0",
			"max": "1000",
			"unit": "ug/m3"
		},
		{
			...
			"type": "GUJT",
			"cat": "gas",
			"description": "Value of Temprature",
			"types": "string",
			"min": "0",
			"max": "100",
			"unit": "C"
		},
		{
			...
			"type": "GUJT",
			"cat": "gas",
			"description": "Value of Ozone gase in ug/m3",
			"types": "string",
			"min": "0",
			"max": "1000",
			"unit": "ug/m3"
		...
		},
		{
			...
			"type": "GUJT",
			"cat": "Weather",
			"description": "Value of Wind Direction in Degree",
			"types": "string",
			"min": "0",
			"max": "360",
			"unit": "degree"
		...
		},
		{
			...
			"type": "GUJT",
			"cat": "Weather",
			"description": "Value of Wind Speed in m/s",
			"types": "string",
			"min": "0",
			"max": "10",
			"unit": "m/s"
		...
		{
			"fkey": "g8",
			"label": "Sulpher Dioxide",
			"type": "GUJT",
			"cat": "gas",
			"description": "Value of SO2 gas",
			"types": "string",
			"min": "0",
			"max": "10",
			"unit": "ug/m3"
		},
		{
			...
			"type": "GUJT",
			"cat": "gas",
			"description": "Value of Air Quality Index",
			"types": "integer",
			"min": "0",
			"max": "500",
			"unit": ""
		},
		{
			...
			"type": "GUJT",
			"cat": "gases",
			"description": "Value of SO2 gase in ug/m3",
			"types": "string",
			"min": "0",
			"max": "2000",
			"unit": "ug/m3"
		},
		{
			...
			"type": "GUJT",
			"cat": "rain",
			"description": "Value of Rain in in",
			"types": "string",
			"min": "0",
			"max": "10",
			"unit": "in"
