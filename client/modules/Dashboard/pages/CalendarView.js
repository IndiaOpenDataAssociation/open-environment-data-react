        ...
        <div className="analytics-div">
          <div className="analytics-chart">
            ...
            <div className="chart-btn-group">
              <a
                className={this.props.activeGraph == 'analytics' ? 'active' : ''}
                onClick={() => {this.props.changeGraphData('analytics')}}
              >
                <img src="../../../assets/images/icons/analytics_w.png"/>
              </a>
              <a
                className={this.props.activeGraph == 'realtime' ? 'active' : ''}
                onClick={() => {this.props.changeGraphData('realtime')}}
              >
